...
import com.curso.algaworks.algafood.util.ExtraindoJson;
...
class CadastroRestauranteIT {
    ...
    public void setUp() {
        ...
        jsonRestauranteCorreto = ExtraindoJson.getContentFromResource(
                "/json/correto/restaurante-new-york-barbecue.json");
        
        jsonRestauranteSemFrete = ExtraindoJson.getContentFromResource(
                "/json/incorreto/restaurante-new-york-barbecue-sem-frete.json");
        
        jsonRestauranteSemCozinha = ExtraindoJson.getContentFromResource(
                "/json/incorreto/restaurante-new-york-barbecue-sem-cozinha.json");
        
        jsonRestauranteComCozinhaInexistente = ExtraindoJson.getContentFromResource(
